...
class ShiftGenerateCommand extends Command
{
    ...
    public function __construct(EntityManagerInterface $entityManager, EngineInterface $templating, \Swift_Mailer $mailer, UrlGeneratorInterface $urlGenerator, array $shiftEmail)
    {
        parent::__construct();
